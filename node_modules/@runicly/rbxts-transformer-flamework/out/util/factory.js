...
(function (f) {
    ...
    f.call = call;
    function newExpression(expression, args, typeArguments) {
        return factory.createNewExpression(toExpression(expression, identifier), typeArguments, args === null || args === void 0 ? void 0 : args.map(function (x) { return toExpression(x); }));
    }
    ...
    function spread(expression) {
        return typescript_1.default.factory.createSpreadElement(toExpression(expression));
    }
    f.spread = spread;
    /// Statements
