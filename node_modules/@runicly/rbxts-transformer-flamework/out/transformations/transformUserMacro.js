...
function transformUserMacro(state, node, signature) {
    ...
    for (var i = 0; i < (0, getParameterCount_1.getParameterCount)(state, signature); i++) {
        ...
        if (!(0, isUndefinedArgument_1.isUndefinedArgument)(args[i])) {
            continue;
        }
...
function getUserMacroOfMany(state, node, target) {
    ...
    else if ((0, isObjectType_1.isObjectType)(target)) {
