...
declare namespace ByteNet {
	...
	type array<T extends ByteNetType<any>> = ByteNetType<T["value"][]>;
	type struct<T extends { [index: string]: ByteNetType<any> }> = ByteNetType<{
		[valueName in keyof T]: T[valueName]["value"];
	}>;
	type optional<T extends ByteNetType<any>> = ByteNetType<T["value"] | undefined>;
	type map<K extends ByteNetType<any>, V extends ByteNetType<any>> = ByteNetType<Map<K["value"], V["value"]>>;
	type packet<T extends ByteNetType<any>> = {
