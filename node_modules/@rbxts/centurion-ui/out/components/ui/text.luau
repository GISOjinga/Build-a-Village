...
local function Text(props)
	local _attributes = {
		FontFace = function()
			return read(props.font) or options().font.regular
		end,
		Text = props.text,
		TextColor3 = props.textColor,
		TextSize = function()
			local _condition = read(props.textSize)
		...
		AutoLocalize = function()
			return options().autoLocalize
		end,
	...
	_attributes.action = props.action
	...
	return Vide.jsx("textlabel", _attributes, props.cornerRadius and Vide.jsx("uicorner", {
