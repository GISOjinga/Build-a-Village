type Assets = Folder & {
	...
	UI: Folder & {
		...
		GameUI: ScreenGui & {
			...
			DailyQuests: Frame & {
				Quest3: Frame & {
					...
					ItemRecievedFrame: Frame & {
						TotalOfItem: TextLabel & {
							UICorner: UICorner;
							UIAspectRatioConstraint: UIAspectRatioConstraint;
							UIPadding: UIPadding;
							UIStrokeText: UIStroke;
		...
		AllRenders: ScreenGui & {
			...
			Honeycomb: ViewportFrame & {
				Honeycomb: Tool & {
					Handle: Part;
				};
				Camera: Camera;
			};
			Statue: ViewportFrame & {
				Camera: Camera;
				Statue: Tool & {
					Handle: Part;
				};
