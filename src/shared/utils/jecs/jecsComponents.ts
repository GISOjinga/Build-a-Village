...
export const Pending = component<Entity>("_CanQuery_")
...
export const CanQuery = <T>(comp: Entity<T>) => { pendingQuery.add(comp); return pair<T, undefined>(Pending as unknown as Entity<T>, comp as unknown as Entity<undefined>) }
