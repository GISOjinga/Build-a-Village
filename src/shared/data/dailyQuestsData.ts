...
export default [
    ...
    { id: 18, description: "Use the gift prompt while holding produce", target: 1, action: "misc", reward: { type: "Coins", amount: 180 } },
    { id: 19, description: "Gift a produce to another player", target: 1, action: "misc", reward: { type: "Produce", name: "Berries" } },
    { id: 20, description: "Visit a friend's village", target: 1, action: "misc", reward: { type: "Villager", name: "Woodsman" } },
    { id: 21, description: "Gift a Tier 1 produce item", target: 1, action: "misc", reward: { type: "Coins", amount: 210 } },
    { id: 22, description: "Collect 20 items", target: 20, action: "misc", reward: { type: "Coins", amount: 220 } },
    { id: 23, description: "Be in a server with 3+ players", target: 3, action: "misc", reward: { type: "Coins", amount: 230 } },
    { id: 24, description: "Sell an item worth over $300", target: 1, action: "misc", reward: { type: "Coins", amount: 240 } },
    { id: 25, description: "Fully fill a Tier 2 station queue", target: 1, action: "misc", reward: { type: "Villager", name: "Miner" } },
