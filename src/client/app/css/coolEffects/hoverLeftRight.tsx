 ...
 */
export function HoverLeftRight({ range, children }: { range: NumberRange, children?: ReactNode }) {
    ...
    useEffect(() => {
        ...
        function changePosition(thingToMotion: Ripple.Motion<UDim2>) {
            ...
            // tween the position
            thingToMotion.tween(UDim2.fromScale(.5 + value, .5), { time: math.random(3, 5), direction: Enum.EasingDirection.InOut, style: Enum.EasingStyle.Cubic })
        }
